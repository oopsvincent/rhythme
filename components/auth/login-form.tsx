...
//         </CardHeader>
//         <CardContent>
//           {/* Email/Password login via server action */}
...
//             Don&apos;t have an account?{" "}
//             <a href="/auth/new" className="underline underline-offset-4">
//               Sign up
//             </a>
//           </div>
//         </CardContent>
    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        <div className="flex justify-center items-center gap-5">
          ...
          <div className={`${errorData.error !== null || errorData.errorDescription !== null ? "flex" : "hidden"}`}>
            {errorData && (

...
export default function SignupIntroPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col justify-between p-6 sm:p-10 select-none">
      ...
      <main className="relative z-10 w-full max-w-4xl mx-auto flex-1 flex flex-col items-center justify-center py-10 sm:py-16 gap-10">
        ...
        {/* Dynamic Card Grid (Updated Features) */}
...
function FeatureCard({ icon, title, description, badge, index }: FeatureCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
      className="group p-6 backdrop-blur-md bg-card/30 hover:bg-card/45 border border-border/40 hover:border-primary/30 rounded-[24px] shadow-xs hover:shadow-lg hover:shadow-primary/2 transition-all duration-300 flex flex-col gap-4 text-left justify-between"
    >

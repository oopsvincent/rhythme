    ...
    <div className="container mx-auto px-5">
      ...
      <div className="flex justify-center flex-wrap gap-4 mb-8 mt-5 [&>*]:w-[40%] lg:[&>*]:w-[23%]">
        ...
        <div className="bg-blue-50 p-4 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-blue-600">{statsResult.data?.todo ?? 0}</p>
        </div>
        <div className="bg-yellow-50 p-4 rounded-lg shadow">
          <p className="text-gray-600">In Progress</p>
          <p className="text-2xl font-bold text-yellow-600">{statsResult.data?.in_progress ?? 0}</p>
        </div>
        <div className="bg-green-50 p-4 rounded-lg shadow">
          <p className="text-gray-600">Completed</p>
          <p className="text-2xl font-bold text-green-600">{statsResult.data?.completed ?? 0}</p>
        </div>
      </div>
